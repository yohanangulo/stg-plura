  ...
  return (
    <Accordion type="multiple" className="w-full" defaultValue={['Typography', 'Dimensions', 'Decorations', 'Flexbox']}>
      <AccordionItem value="Custom" className="px-6 py-0  ">
        <AccordionTrigger className="!no-underline">{t('custom')}</AccordionTrigger>
        <AccordionContent>
          {state.editor.selectedElement.type === 'link' && !Array.isArray(state.editor.selectedElement.content) && (
            <div className="flex flex-col gap-2">
              <p className="text-muted-foreground">{t('linkPath')}</p>
              <Input
                id="href"
      ...
      <AccordionItem value="Typography" className="px-6 py-0  border-y-[1px]">
        <AccordionTrigger className="!no-underline">{t('typography')}</AccordionTrigger>
        <AccordionContent className="flex flex-col gap-2 ">
          <div className="flex flex-col gap-2 ">
            <p className="text-muted-foreground">{t('textAlign')}</p>
            <Tabs
              onValueChange={e =>
                handleOnChanges({
                  target: {
          ...
          <div className="flex flex-col gap-2">
            <p className="text-muted-foreground">{t('fontFamily')}</p>
          ...
          <div className="flex gap-4">
            <div>
              <Label className="text-muted-foreground">{t('fontWeight')}</Label>
              <Select
                onValueChange={e =>
                  handleOnChanges({
                    target: {
      ...
      <AccordionItem value="Dimensions" className=" px-6 py-0 ">
        <AccordionTrigger className="!no-underline">{t('dimensions')}</AccordionTrigger>
        <AccordionContent>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex gap-4 flex-col">
                <div className="flex gap-4">
                  ...
                  <div>
                    <Label className="text-muted-foreground">{t('width')}</Label>
                    <Input
                      placeholder="px"
                      id="width"
                      onChange={handleOnChanges}
              ...
              <div className="flex gap-4 flex-col">
                <div className="flex gap-4">
                  <div>
                    <Label className="text-muted-foreground">{t('top')}</Label>
                    <Input
                      id="marginTop"
                      placeholder="px"
                      onChange={handleOnChanges}
                  ...
                  <div>
                    <Label className="text-muted-foreground">{t('bottom')}</Label>
                    <Input
                      placeholder="px"
                      id="marginBottom"
                      onChange={handleOnChanges}
                ...
                <div className="flex gap-4">
                  <div>
                    <Label className="text-muted-foreground">{t('left')}</Label>
                    <Input
                      placeholder="px"
                      id="marginLeft"
                      onChange={handleOnChanges}
                  ...
                  <div>
                    <Label className="text-muted-foreground">{t('right')}</Label>
                    <Input
                      placeholder="px"
                      id="marginRight"
                      onChange={handleOnChanges}
      ...
      <AccordionItem value="Decorations" className="px-6 py-0 ">
        <AccordionTrigger className="!no-underline">{t('decorations')}</AccordionTrigger>
        <AccordionContent className="flex flex-col gap-4">
          <div>
            <Label className="text-muted-foreground">{t('opacity')}</Label>
          ...
          <div>
            <Label className="text-muted-foreground">{t('borderRadius')}</Label>
            <div className="flex items-center justify-end">
              <small className="">
          ...
          <div className="flex flex-col gap-2">
            <Label className="text-muted-foreground">{t('backgroundColor')}</Label>
          ...
          <div className="flex flex-col gap-2">
            <Label className="text-muted-foreground">{t('backgroundImage')}</Label>
            <div className="flex  border-[1px] rounded-md overflow-clip">
              <div
                className="w-12 "
                style={{
          ...
          <div className="flex flex-col gap-2">
            <Label className="text-muted-foreground">{t('imagePosition')}</Label>
            <Tabs
              onValueChange={e =>
                handleOnChanges({
                  target: {
      ...
      <AccordionItem value="Flexbox" className="px-6 py-0  ">
        <AccordionTrigger className="!no-underline">{t('flexbox')}</AccordionTrigger>
        <AccordionContent>
          <Label className="text-muted-foreground">{t('justifyContent')}</Label>
          <Tabs
            onValueChange={e =>
              handleOnChanges({
                target: {
          ...
          <Label className="text-muted-foreground">{t('alignItems')}</Label>
          <Tabs
            onValueChange={e =>
              handleOnChanges({
                target: {
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <Label className="text-muted-foreground">{t('flex')}</Label>
          </div>
          <div>
            <Label className="text-muted-foreground">{t('direction')}</Label>
            <Input
              placeholder="px"
              id="flexDirection"
              onChange={handleOnChanges}
